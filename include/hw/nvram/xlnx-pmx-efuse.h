...
#define TYPE_XLNX_EFUSE_MAP_XC2VP3202 "xlnx.efuse-map-xc2vp3202"
...
typedef enum XlnxEfuseBitIdx {
    ...
    XLNX_EFUSE_BIT_SVD_WR_LK,
    XLNX_EFUSE_BIT_DNA_WR_LK,
    XLNX_EFUSE_BIT_CAHER_WR_LK,
...
typedef enum XlnxEfuseAccessCtrl {
    ...
    XLNX_EFUSE_AC_GLITCH_DET_WR_LK,
    XLNX_EFUSE_AC_TBIT0,
    XLNX_EFUSE_AC_DME,
    XLNX_EFUSE_AC_DNA,
    XLNX_EFUSE_AC_FACTORY,
    XLNX_EFUSE_AC_RFSOC,
    XLNX_EFUSE_AC_FACTORY_BOOT_ENV_WR_LK,
    XLNX_EFUSE_AC_FACTORY_ROW0,
    XLNX_EFUSE_AC_TBIT0_UDS_WR_LK,
    XLNX_EFUSE_AC_TBIT0_PPK0_WR_LK,
    XLNX_EFUSE_AC_TBIT0_PPK1_WR_LK,
    XLNX_EFUSE_AC_TBIT0_PPK2_WR_LK,
    XLNX_EFUSE_AC_TBIT0_AES_WR_LK,
    XLNX_EFUSE_AC_TBIT0_USER_KEY_0_WR_LK,
    XLNX_EFUSE_AC_TBIT0_USER_KEY_1_WR_LK,
    XLNX_EFUSE_AC_TBIT0_PUF_SYN_LK,
    XLNX_EFUSE_AC_TBIT0_REVOKE,
    XLNX_EFUSE_AC_TBIT1_PUF_SYN_LK,
    XLNX_EFUSE_AC_TBIT0_PPK3_WR_LK,
    XLNX_EFUSE_AC_TBIT0_PPK4_WR_LK,
